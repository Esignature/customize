...
//$captcha->wordsFile = 'words/es.php'; $captcha->session_var = 'secretword';
//$captcha->imageFormat = 'png'; $captcha->scale = 3; $captcha->blur = true;
...
class SimpleCaptcha {
	...
	/** Font Size. Applicable only if not null */
    public $fontSize  = 30; // null or number;
    ...
    public $fonts = array(
        ...
        'DingDong' => array('spacing' => 1, 'minSize' => 24, 'maxSize' => 30, 'font' => 'Ding-DongDaddyO.ttf'),
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        for ($i=0; $i<$length; $i++) {
            ...
            $fontsize = $this->fontSize != null ? $this->fontSize : rand($fontcfg['minSize'], $fontcfg['maxSize'])*$this->scale*$fontSizefactor;
