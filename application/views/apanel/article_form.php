<script type="text/javascript" src="<?php echo $path;?>js/validate.article.js"></script>
<?php
...
<ul id="buttons">
    ...
    <li class="todo_icon" title="Cancel"><?=anchor('apanel/article', '<img src="'.$path.'img/block_32.png" alt="Cancel" />')?></li>
</ul>
<h2>Article Manager</h2>
<?php 
	echo $message; 
	echo validation_errors('<div class="fail curved8 hidden">', '</div>'); 
	echo form_open('apanel/article_form', array('class'=>'form01'));
?>
<div id="tabs">
    <ul class="tab_link">
    ...
    <p>
        <label>Title</label>
        <input name="title" type="text" class="input medium form_tip" title="Enter the title of your article." id="title" value="<?=set_value('title', $form['title'])?>" />
        <span class="abt_info">This appears at your browser's title bar.</span>
    </p>
    <p>
        <label>Slug</label>
        <input name="slug" type="text" class="input medium slug form_tip" title="Enter the slug for the article.<br />Use alphanumeric characters only." id="slug" value="<?=set_value('slug', $form['slug'])?>" maxlength="80" />
    ...
    <p class="img_upload">
        ...
        <span class="abt_info">This image will be used for the article list and thumbnail image. <br /><span style="color:red;">*You can upload only JPG image</span></span>
    ...
    <p>
        <label>Artists in this article</label>
        <input type="text" name="artist" id="artist_txt" class="input medium form_tip" /> 
        <img src="<?=$path?>img/accept.png" id="insert_artist" alt="Add Artist" class="todo_icon" title="Click to add the artist to the article." />
    ...
    <p>
        ...
        <span class="abt_info">Enter the tags for the article, so that we can show the related articles.</span>
    ...
    <p>
        ...
        <span class="abt_info">Describe about this article in a sentence.</span>
    </p>
    </div>
    ...
    <p>
        ...
        <span class="abt_info">Enter the name of the article writer.</span>
    </p>
    <p>
        <label>Status</label>
<?php
...
?>
        ...
        Off
        <span class="abt_info">Publish this article. Select now or later.</span>
    </p>
    <p>
...
?>
        ...
        Common
        <span class="abt_info">This will mark this article as featured.</span>
    </p>
    <p>
...
<input type="hidden" name="post_task" id="post_task" value="0" />
    ...
    <div id="sidebar">
        <ul>
            <?php
			    echo anchor('apanel/article', '<img src="'.$path.'img/001_20.png" width="24" height="24" alt="List" />View all articles');
				$cls = ($is_add) ? array('class'=>'active') : array();
				echo anchor('apanel/article_form', '<img src="'.$path.'img/addpage.png" width="24" height="24" alt="Add" />Add Article', $cls);
			?>
        </ul>
   </div>
